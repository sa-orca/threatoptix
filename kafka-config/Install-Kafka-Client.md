...
bin/kafka-topics.sh --describe --topic test-events --zookeeper $ZOOKPR

bin/kafka-console-producer.sh --broker-list $BBROKERS \
    --producer.config $PROPERTIES_FILE --topic test-events

bin/kafka-console-consumer.sh --bootstrap-server $BBROKERS \
    --consumer.config $PROPERTIES_FILE --topic test-events
...
bin/kafka-topics.sh --create --topic test-events-iam \
...
bin/kafka-console-producer.sh --broker-list $BBROKERS \
    --producer.config $PROPERTIES_FILE --topic test-events-iam

bin/kafka-console-consumer.sh --bootstrap-server $BBROKERS \
    --consumer.config $PROPERTIES_FILE --topic test-events-iam

bin/kafka-console-consumer.sh --bootstrap-server $BBROKERS \
    --consumer.config $PROPERTIES_FILE \
    --topic test-events-iam --from-beginning
```
